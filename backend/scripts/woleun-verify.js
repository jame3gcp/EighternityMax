 ...
 * 참조: 1월=己丑 … 12월=庚子 (구 검증표 순서: 1月=丑 2月=寅 … 12月=子)
 * 현재 saju.js 월운은 참조 사이트 beta-ybz6에 맞춰 1月=子 2月=亥 … 12月=丑 순서를 사용하므로
 * 이 스크립트의 ref와는 순서가 다름. beta-ybz6 검증은 npm run saju-verify-dataset 사용.
 *

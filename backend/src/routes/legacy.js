...
router.get('/interpretations/:phaseId', (req, res) => {
  ...
  if (content.recommendationItems) payload.recommendationItems = content.recommendationItems;
  if (content.warningItems) payload.warningItems = content.warningItems;
  res.json(payload);
});
